...
description:
  "Alternative dark theme strategy using flipped color scales instead of separate palette."
keywords: ["colors-dark-flip-base.css", "dark theme", "flipped colors", "palette strategy"]
---
