...
description:
  "Core CSS variables stylesheet. Base and composed variables used by Shilp CSS utilities."
keywords: ["variables.css", "CSS variables", "state variables", "utility variables"]
---
