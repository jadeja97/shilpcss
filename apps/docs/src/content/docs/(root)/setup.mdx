...
description:
  "Step-by-step installation guide for Shilp CSS with Vite and Webpack. Configure bundler plugins
  and optimize your styling workflow."
keywords: ["install", "setup", "Vite", "Webpack", "plugin", "bundler", "configuration"]
---
