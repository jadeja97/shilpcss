...
const TheProblem = (): ReactElement<HTMLElement> => (
  <section>
    ...
    <p>Modern CSS tooling optimized for shipping speed, by moving styling decisions into markup.</p>
    ...
    <p>
      <strong>Shilp CSS exists to move style decisions back into CSS.</strong> <br /> Where they can
      be named, owned, and changed safely.
    </p>
  </section>
);
