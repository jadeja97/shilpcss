...
const Strength = (): ReactElement<HTMLElement> => (
  <section>
    ...
    <p>
      My core strength is quickly understanding how systems work, identifying patterns, and building
      structures that make development more predictable over time.
    </p>
    ...
    <p>
      <strong>
        I may not claim to know everything, but I take ownership, learn fast, and deliver dependable
        results.
      </strong>
    </p>
  </section>
...
const Contact = (): ReactElement<HTMLElement> => (
  <section>
    ...
    <p>
      If the direction of the project or the way I work aligns with what you are building, feel free
      to reach out. I am happy to connect and discuss how I can contribute.
    </p>
  </section>
);
