...
Thanks for your interest in contributing to Shilp CSS. Contributions are welcome! 🤗
...
[Create an Issue](https://github.com/JadejaHQ/shilpcss/issues) on our GitHub repository.
...
[Feature Request](https://github.com/JadejaHQ/shilpcss/discussions/new?category=ideas) on our GitHub
repository.
...
2. [Create an Issue](https://github.com/JadejaHQ/shilpcss/issues) or
   [Feature Request](https://github.com/JadejaHQ/shilpcss/discussions/new?category=ideas) if not
   exist.
3. Follow Branch naming conventions
   ...
   - > For example, <br> If issue (feature request) url is
     > https://github.com/JadejaHQ/shilpcss/issues/11, <br> then your branch name must be `feat-11`
...
6. Ensure your code adheres to the project's coding style and conventions.
   - run `pnpm check --filter=shilpcss`
...
- `pnpm check --filter=shilpcss`
- `pnpm fix --filter=shilpcss`
